...
function FooterProduct({ data, opened, total, handleItemOrder, disable }) {
    ...
    return (
        <Box position='fixed' bottom={0} left={0} w='100%' zIndex={998} bg='transparent'>
                ...
                >
                    {!opened ? (
                        <Box textAlign='center' py='10px'>
                            <Text fontSize='lg' fontWeight={700}>Fechado no momento!</Text>
                            <Text fontSize='sm' color='#6B7280'>No momento, não estamos aceitando novos pedidos.</Text>
                        </Box>
                    ) : (
                        <Button
                            w='100%'
                            ...
                            bgGradient={disable || data?.primary_color ? undefined : 'linear(to-r, #FFC42D, #F59E0B)'}
